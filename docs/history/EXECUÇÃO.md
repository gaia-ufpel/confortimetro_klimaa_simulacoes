...
#### Interface Legada (Compatibilidade)
```python
from confortimetro.gui import SimulationGUI
...
```bash
# Testar imports
python -c "from confortimetro.gui.main_window import MainWindow; print('✅ Import OK')"

# Testar criação da interface
python -c "from confortimetro.gui.main_window import MainWindow; app = MainWindow(); app.destroy(); print('✅ Interface OK')"
```
